function [peak_idx, thresh_array] = My_Cifar_LR(num_train_cells, num_guard_cells, data, prob_false_alarm, plot_frequency)
%{
...
%     end
    ...
    sum_of_left= sum(data(i - num_side : i - num_guard_cells_half + 1 - 1 - 1 ));
    sum_of_right= sum(data(i + num_guard_cells_half + 1 : i + num_side + 1 - 1));
    noise_power = (sum_of_right + sum_of_left) / num_train_cells;
